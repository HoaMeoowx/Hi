...
local function v0_()
	...
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("Kitty") then

			makefolder("Kittt")

		end

		if not isfolder("Kitty/Blox Fruits/") then

			makefolder("Kitty/Blox Fruits/")
...
local v7 = v4:CreateWindow({
	...
	Title = "Kitty Lazy Hub",

	SubTitle = "this is kitty lazy",
...
local v71 = "rbxassetid://121203599534042"
